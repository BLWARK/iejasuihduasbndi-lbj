...
const follow = () => {
  return (
    <div className="mt-12 border-t flex 2xl:flex-row flex-col 2xl:justify-between 2xl:items-center justify-start items-start gap-5 p-6 bg-gray-200 rounded-lg text-black">
