  ...
  return (
    <div className="w-screen bg-gray-900 text-white">
      ...
      <div className="flex justify-start items-center font-bold gap-4 text-[2em] mb-10">
        ...
        <a href="https://www.youtube.com/@lbjtvofficial/videos" target="blank" 
        className="mt-10 bg-red-600 text-white py-3 px-5 rounded-lg font-semibold hover:bg-red-400 transition w-full text-sm "
        >
        Lihat Video Lainnya
        </a>
