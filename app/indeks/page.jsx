...
const LatestNewsPage = () => {
  ...
  const itemsPerPage = 9; // 🔥 Jumlah berita per halaman
          ...
          <div className="flex justify-center items-center mt-6 gap-2 ">
            ...
            {startPage > 1 && (
              <button
                ...
                className="px-4 py-2 text-sm font-semibold rounded-md bg-gray-300 text-gray-800 hover:bg-gray-400"
              >
                1
              </button>
            )}
            ...
            {Array.from({ length: endPage - startPage + 1 }, (_, index) => startPage + index).map((pageNumber) => (
              <button
                ...
                className={`px-4 py-2 text-sm font-semibold rounded-md transition bg-gray-300 text-gray-800 hover:bg-gray-400 ${
