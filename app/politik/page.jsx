...
import newsData from "@/data/news"; // Data berita politik
import usersData from "@/data/users"; // Data penulis
import PopularNews from "@/components/PopularNewsPage"; // Komponen berita populer
import LatestNewsList from "@/components/LatestNewsList"; // Komponen berita terbaru
...
// ✅ Filter berita kategori "Politik"
...
const additionalNews = politikNews.slice(1, 5); // 4 berita tambahan
const latestNews = politikNews.slice(1, 10); // 10 berita terbaru

// ✅ Filter berita terpopuler berdasarkan views
const popularNews = politikNews
  .sort((a, b) => b.views - a.views)
  .slice(0, 4); // 4 berita politik terpopuler
...
const PolitikPage = () => {
  return (
    <div className="w-full 2xl:flex xl:flex lg:flex flex-row 2xl:max-w-[1200px] xl:max-w-[1200px] lg:max-w-[1020px] mx-auto py-6">
      ...
      <div className="2xl:w-[75%] xl:w-[75%] lg:w-[75%] w-full flex flex-col gap-2 2xl:pr-4 xl:pr-4 lg:pr-4 px-2">
